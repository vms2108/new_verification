...
export class AuthService {
  ...
  private AUTH_INFO_FIELD = 'bonum_verification_auth_info';
  private USER_INFO_FIELD = 'bonum_verification_user_info';

  public verificationInProgess = false;
  public verificationSended = new Subject<any>();
  public authStatusChanged = new BehaviorSubject<any>(undefined);
